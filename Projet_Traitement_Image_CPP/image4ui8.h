...
/** Colored images with 4*8 bits unsigned int
 */
class Image4UI8 : public Image
{
public:
    /** Intialize with the width, height, and the max grayscaled value
     */
    Image4UI8(unsigned int const width, unsigned int const height, unsigned short const max);
    /** Destructor
     */
    ~Image4UI8();
public: // accessing to dimensions
    /** Return 4 for the depth
     */
